export declare let HyperUtils: {
    ...
    getUrlParam: (paramName: any) => string | undefined;
    ...
    sortObjMapProperty: (objMap: any, propName: any, asc: any, isDate: any) => {} | null;
    ...
    findCollection: (objs: any, objMatch: any) => {};
    findCollectionFieldValueIn: (objs: any, fieldName: any, values: any) => {};
    findCollectionFieldValueNotIn: (objs: any, fieldName: any, values: any) => {};
    findCollectionQuery: (collection: any, queryObject: any) => {};
    ...
    list: (objMap: any, fieldName: any, distinct: any) => any[] | undefined;
    arrayDistinct: (array: any) => any[];
    newObjIncludeProperties: (source: any, skipProperties: any) => {} | null;
    ...
    getFbTime: (datetime: any, serverDate: any) => string | null;
    printCaseString: () => any;
